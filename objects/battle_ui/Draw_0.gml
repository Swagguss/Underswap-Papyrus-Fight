...
var _number_coloring = c_white
if global.kr > 0
    _number_coloring = c_fuchsia
draw_set_color(_number_coloring)
...
draw_sprite_ext(spr_pixel,0,x+245+ Player_GetHp() * 1.25,y-1,global.kr * -1.25,21,0,c_fuchsia,1);
